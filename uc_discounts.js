...
//   function uc_discountsOnLoad(event) {
//     context = $('body');
//     uc_discountsProcessCodes(context, event);
// 
...
//   function uc_discountsProcessCodes(context, event) {
...
//           calculateDiscountResponse = jQuery.parseJSON(responseText);
//         }
//         catch (err) {
